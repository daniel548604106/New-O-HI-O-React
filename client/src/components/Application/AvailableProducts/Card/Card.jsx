...
const Card = () => {
  const items = [
    {
      img: 'https://cdn04.pinkoi.com/O.HI.O.site/event/store-intro/sellables_original.jpg',
      title: '原創商品',
      valid: '由設計師本人（或團隊）親自發想、設計，且符合  O.HI.O 商品販售政策。',
      invalid: '使用工廠大量製造的公版成品再貼標而產出的商品。',
    },
    {
      img: 'https://cdn04.pinkoi.com/O.HI.O.site/event/store-intro/sellables_authorized.jpg',
      title: '授權販售商品',
      valid: '得到原廠品牌或商品原創者書面授權或擁有其他合法權源。',
      invalid: '至各地少量帶貨、批貨而來之商品。',
    },
    {
      img: 'https://cdn04.pinkoi.com/O.HI.O.site/event/store-intro/sellables_vintage.jpg',
      title: '十年老件',
